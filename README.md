...
```
	tar -xvzf newrelic_memcached_plugin-X.Y.Z.tar.gz
```
...
**Q: Does this plugin support Memcached's Binary Protocol?**

**A:** Currently no, we do have it on our roadmap but do not know when that will actually make its way out the door.  That said, if this is an important workflow for you, we highly encourage you to fork the code!  Check out the 'Fork me!' section below for details.
